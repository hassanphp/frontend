...
BuildHTML = function () {
  function BuildHTML() {_classCallCheck(this, BuildHTML);
	...
	this.userImgMe = 'user-img';
	this.userImgThem = 'user-img-right';
    ...
    text, who) {
      return '<div class="' + this.messageWrapper + ' ' + this[who + 'Class'] + '"><img src="img/user-img.svg" alt="" class="circle responsive-img user-img' + this[who + 'Class'] + '"> \n            <div class="' +
